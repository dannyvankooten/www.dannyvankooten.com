...
Alternatively, we can skip the package from the Alpine Package Repository entirely and instead install the latest version of Composer ourselves following the [installation instructions from its website](https://getcomposer.org/download/).
