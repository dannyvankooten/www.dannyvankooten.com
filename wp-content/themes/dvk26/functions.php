...
add_action('wp_enqueue_scripts', static function () {
    wp_enqueue_style('inter', get_stylesheet_directory_uri() . '/assets/fonts/inter.css', [], null);
    wp_enqueue_style('dvk26', get_stylesheet_uri(), [], filemtime(get_stylesheet_directory() . '/style.css'));
}, 1);
